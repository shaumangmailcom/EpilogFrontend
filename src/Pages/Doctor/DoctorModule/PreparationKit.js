    ...
    <DoctorLayout>
      ...
      <div className={styles.prepkitBtns}>
        <AppButton
          ...
          boxMargin="0"
        />
        <AppButton title="Send" width="138px" height="39px" boxMargin="0" />
      </div>
      <TextSec margin="52px 0 0" textAlign="center" text={<span><span style={{fontFamily: 'heebo700'}}>Tip: </span>You can always take a screenshot and share a picture in WhatsApp</span>} />
    </DoctorLayout>
  );
};
